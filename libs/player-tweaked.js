...
Modplayer.prototype.load = function(url, bytebuffer)  // TODO: Added bytebuffer parameter so I can test passing it into the module replay later
{
  ...
  request.onload = function() {
    // TODO: I hacked this to test if I could pass in a byte array easily instead of using the response to the AJAX load, it works.
    //       So now I need to just code myself a simpler player routine which uses the Protracker() (pt.js) replayer directly.
    var buffer=new Uint8Array(bytebuffer); // new Uint8Array(request.response);
    this.state="parsing..";
